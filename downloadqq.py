...
#     tags_all = soup.find_all('a', {'class': 'link_nav', 'target': '_blank'})
#     #print "tags_all = \n"
#     print tags_all
...
#     global conn
#
#     tags_url = "http://v.qq.com/x/list/tv?sort=4&offset=0"
#     #print tags_url
    ...
    try:
        ...
        if "index" in args[0]:
            ...
            if args[1] == 0:
                ...
                qq_down_them_all(args[0], int(args[1]))
    except IndexError:
        usage_tip(0)
    except ValueError:
        usage_tip(1)
#https://www.bilibili.com/video/av2274779/
def qq_down_them_all(link, p_count):
    for i in range(1,p_count+1):
        print("Start downloading...\n%s\n" % link)
        call("you-get -d " + link + "index_" + str(i) + ".html" + " -o ~/ping/tmp/qq", shell=True)
...
def usage_tip(exit_flag):
    ...
    print("Usage: python qq_download_them_all.py [PageLink] [VideoCount]")
    print("Example: python qq_download_them_all.py ")
    sys.exit(exit_flag)
